...
var MaskComponent = (function () {
    ...
    MaskComponent.prototype.searchNearestService = function (event) {
        ...
        if (this.isFoodSelected) {
            setTimeout(function () {
                _this.foodService.getNearestFood()
                    ...
                    _this.isEventMapVisiable = false;
        ...
        // 7. If other service tab is selected and event radio button is ticked
        if (this.isOtherServicesSelected && this.isEventRadioButtonSelected) {
            setTimeout(function () {
                _this.otherService.getNearestEvent()
                    .subscribe(function (eventInfo) {
                    _this.nearestService = eventInfo;
                    _this.isEventMapVisiable = true;
                    _this.isPetHealthcareServiceMapVisiable = false;
                    _this.isFoodServiceMapVisiable = false;
                    _this.isAccommodationServiceMapVisiable = false;
                    _this.isEmergencyPetBoardingServiceMapVisiable = false;
    ...
    MaskComponent.prototype.searchAllServices = function (event) {
        ...
        if (this.isOtherServicesSelected && this.isEventRadioButtonSelected) {
            setTimeout(function () {
                _this.otherService.getEvents()
                    .subscribe(function (events) {
                    _this.allServices = events;
                    _this.cachedAllServices = events;
                    _this.isEventMapVisiable = true;
                    _this.isPetHealthcareServiceMapVisiable = false;
                    _this.isFoodServiceMapVisiable = false;
                    _this.isAccommodationServiceMapVisiable = false;
